...
@section('content')
    ...
    {!! Form::open() !!}
        @include('partials/form/text', ['name' => 'invite', 'label' => 'Invite code', 'placeholder' => 'Secret activation code', 'help' => 'Check your email invite for this code.', 'autocapitalize' => 'off'])
